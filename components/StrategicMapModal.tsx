    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl bg-[#0A0A0A] border border-corp-blue/30 shadow-[0_0_50px_rgba(0,122,255,0.15)] rounded-sm overflow-hidden animate-fade-in flex flex-col max-h-[90vh]">
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-10 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')]">
            ...
            <div className="relative pl-8 p-6 border border-corp-gold/20 bg-gradient-to-r from-corp-gold/5 to-transparent rounded-sm gold-fog">
                <div className="absolute -left-[1px] top-0 bottom-0 w-[2px] bg-corp-gold shadow-[0_0_15px_rgba(212,175,55,0.8)]"></div>
                
                <div className="flex justify-between items-start">
                    <div>
                        <div className="flex items-center gap-2 mb-2">
                             <span className="text-[10px] font-bold text-corp-gold font-mono tracking-widest border border-corp-gold/30 px-2 py-0.5 bg-black">TIER F</span>
                             <Crown size={12} className="text-corp-gold animate-pulse" />
                        </div>
                        <h3 className="text-2xl font-display font-bold text-corp-gold tracking-tight mb-2 drop-shadow-[0_0_10px_rgba(212,175,55,0.5)]">
                            {TIER_GROUPS.F.subtitle}
                        </h3>
                        <p className="text-xs text-corp-gold/80 font-mono italic">"The End Game. You make the rules."</p>
                    </div>
                    <Lock size={16} className="text-corp-gold/50" />
                </div>
            </div>
            ...
            <div className="relative pl-8 group">
                 ...
                 <div className="bg-corp-bg/80 border border-corp-border p-5 rounded-sm hover:border-corp-silver/50 transition-colors">
                     <div className="flex justify-between items-start mb-3">
                         <div className="flex items-center gap-2">
                            ...
                            <Lock size={12} className="text-corp-platinum group-hover:animate-shake" />
                         </div>
                         <span className="text-[9px] text-corp-silver font-mono animate-pulse">LOCKED // NEXT OBJECTIVE</span>
                     </div>
