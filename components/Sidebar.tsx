...
import { Shield, Lock, Crown, ChevronRight, LayoutGrid, Clock, Gem, FileText, Briefcase } from 'lucide-react';
      ...
      <div className="p-6 space-y-8 flex-1 overflow-y-auto">
        ...
        <div className="mt-8">
             <div className="flex items-center gap-2 text-[10px] font-mono text-corp-gold uppercase tracking-widest mb-3">
                <Lock size={12} /> The Vault <span className="text-corp-silver opacity-50"> // €299 TIER</span>
             </div>
             ...
             <div className="bg-gradient-to-r from-corp-gold/5 to-transparent border-l-2 border-corp-gold p-4 space-y-3">
                 <div className="flex items-center gap-3 text-xs text-corp-platinum/80 hover:text-corp-gold cursor-pointer transition-colors group">
                     ...
                     <span>Salary Negotiation Script v4.0</span>
                 </div>
                 <div className="flex items-center gap-3 text-xs text-corp-platinum/80 hover:text-corp-gold cursor-pointer transition-colors group">
