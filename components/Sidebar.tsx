...
export const Sidebar: React.FC<SidebarProps> = ({ user, onOpenMap, onOpenUpgrade }) => {
    return (
        <div className="w-full md:w-[320px] flex-shrink-0 war-room-panel border-r border-white/10 flex flex-col h-full font-sans relative z-30 bg-corp-onyx/95 backdrop-blur-xl">
